...
Y_dev - original images; iFFT - images reconstructed from frequency space corrupted by motion - ghosting artefacts are clearly seen; Y_recon - images reconstructed using trained model - ghosting is gone!, however, images look very blurry - the cost was still quite high - needs optimizing.
